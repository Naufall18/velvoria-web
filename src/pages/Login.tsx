    ...
    <div className="min-h-screen pt-28 pb-20 bg-[#FAF8F5] flex items-center justify-center px-4">
      <div className="w-full max-w-md bg-white rounded-[2rem] border border-gray-100 shadow-xl p-8 sm:p-10">
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-3xl font-serif font-bold text-[#1A1F3A]">Welcome Back</h1>
          <p className="text-sm text-gray-400 mt-1">Sign in to your Velvoria account</p>
        </div>
        ...
        <p className="text-center text-sm text-gray-400 mt-8">
          ...
          <Link to="/register" className="font-bold text-[#1A1F3A] hover:text-[#E8B4A0] transition-colors">
            Create one
          </Link>
        </p>
      </div>
